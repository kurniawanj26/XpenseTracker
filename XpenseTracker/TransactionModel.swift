...
struct Category {
    ...
    var mainCategoryId: Int? // optional
}
...
extension Category {
    ...
    static let publicTransportion = Category(id: 101, name: "Public Transportation", icon: .bus, mainCategoryId: 1)
